          ...
          <li><a class="collapsible-header waves-effect arrow-r <?=($lc=='usuario'||$lc=='grupo')?'active':''?>"><i class="fas fa-hand-pointer"></i> Usuários e grupos<i class="fas fa-angle-down rotate-icon"></i></a>
            <div class="collapsible-body">
              <ul class="list-unstyled">
                ...
                <li><a href="index.php?pg=index&lc=grupo" class="waves-effect subitem <?=($pg=='index'&&$lc=='grupo')?'active':''?>">Gerenciar grupos</a>
                </li>
              </ul>
            </div>
          </li>
    ...
    <ul class="nav navbar-nav nav-flex-icons ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown"
          aria-haspopup="true" aria-expanded="false"><i class="fas fa-user mr-2"></i>Dropdown
        </a>
